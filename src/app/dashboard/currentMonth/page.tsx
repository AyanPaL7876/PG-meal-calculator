...
function Page() {
    ...
    return (
        <div className='pt-20 flex flex-col gap-10'>
            ...
            {user?.pgId && (
                <>
                    <SummaryTable pgId={user.pgId} currMonth={true} />
                    <SpentTable pgId={user.pgId} currMonth={true} />
                    <MealTable pgId={user.pgId} currMonth={true} />
                    <ExpenseTable pgId={user.pgId} currMonth={true} />
                </>
            )}
        </div>
    );
